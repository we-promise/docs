...
- **LLM probe** — Queries the models list on the configured provider (OpenAI, Anthropic, or any OpenAI-compatible endpoint) and verifies the configured model is available.
