...
- MCP request and response scanning for secret exfiltration, prompt injection, and tool poisoning
- HTTPS tunnel controls for destination, SSRF, rate, budget, and CONNECT headers
