...
Sure includes an optional backup service that automatically backs up your PostgreSQL database on a schedule.

### Enable backups

The backup service is disabled by default. To enable it, start the backup profile:
...
Change `/your/custom/path` to where you want backups stored on your host machine.
