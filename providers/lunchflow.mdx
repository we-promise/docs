...
Lunch Flow offers a referral program where you can earn credits by inviting others to use the service. When you sign up or access your Lunch Flow dashboard, you'll receive a unique referral code that you can share with friends and colleagues.
