...
**On-chain wallets** lets you track self-custody wallets by public address — no API key, no signing, no seed phrase. Supports Bitcoin, six EVM networks (Ethereum, Base, Arbitrum, Optimism, Polygon, Gnosis), and Solana.

- **Best for**: Tracking self-custody wallets directly from the chain
