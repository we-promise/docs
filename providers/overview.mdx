...
**On-chain wallets** lets you track self-custody Bitcoin, EVM, and Solana wallets directly from their public addresses — no API key, no third-party account, and no key or seed phrase required.

- **Best for**: Tracking self-custody wallets across Bitcoin, Ethereum, Base, Arbitrum, Optimism, Polygon, Gnosis, and Solana
