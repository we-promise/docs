...
**On-chain wallets** lets you track Bitcoin, EVM (Ethereum, Base, Arbitrum, Optimism, Polygon, Gnosis), and Solana wallets directly by public address — no API key required for any chain.

- **Best for**: Tracking self-custody wallets without a third-party aggregator
