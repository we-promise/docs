...
**On-chain wallets** lets you track Bitcoin, EVM networks (Ethereum, Base, Arbitrum, Optimism, Polygon, Gnosis), and Solana wallets directly by public address — no API key required for any chain.

- **Best for**: Tracking self-custody wallets without sharing keys or using a third-party aggregator
- **Pricing**: Free (uses public block explorers by default)
