...
- Sure uses a composite key to identify true duplicates based on transaction content:
...
- The `credit_debit_indicator` is included to distinguish between payments and refunds of the same amount on the same day
