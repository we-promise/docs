...
- A Coinbase account
- API credentials from Coinbase Developer Platform

## Getting API credentials

1. Log in to your [Coinbase Developer Platform account](https://portal.cdp.coinbase.com/)
...
<Warning>
Your API secret is only shown once. Store it securely - you'll need it to connect Sure to Coinbase.
</Warning>
