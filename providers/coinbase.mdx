...
2. Click **Connect** on the **Coinbase** card
...
- Fractional quantities with up to 18 decimal places of precision
...
- Cost basis is not available from the Coinbase API and is not tracked
