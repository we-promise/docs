...
This has happened in the wild with Sure. In one confirmed case, the integration started working without app changes after Plaid support reprocessed the user's registration.

When contacting Plaid support, include:

- Your Plaid environment and access tier (for example, Limited Production)
- The institution you are trying to connect
