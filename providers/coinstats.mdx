...
- Exchange account holdings and transactions
...
- Centralized exchange portfolios (Binance, Coinbase, Kraken, and more)
- Automatic normalization of investment charts for linked accounts
...
- **Exchange portfolios**: Sync holdings and transactions from centralized exchanges (Binance, Coinbase, Kraken, etc.)
...
- **Transaction history**: Import historical transactions from your wallets and exchanges
- **Token balances**: Track balances across multiple tokens in each wallet
- **Normalized charts**: Investment charts are automatically normalized for linked CoinStats accounts
