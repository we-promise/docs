...
- **Exchange portfolios** from connected exchanges
- **Transaction history** from wallets and exchanges
- **Real-time price data** for all holdings

The integration supports:
- Multiple blockchain networks (Ethereum, Bitcoin, and more)
- Exchange accounts (Coinbase, Binance, Kraken, etc.)
- Automatic portfolio normalization for linked investments
...
- **Exchange portfolios**: Sync holdings from connected cryptocurrency exchanges
...
- **Chart normalization**: Linked investment charts are automatically normalized during batch processing
