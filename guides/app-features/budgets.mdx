...
You can save a budget that only sets an overall monthly spending amount without splitting it across categories. The budget setup wizard no longer requires any category allocations to be set before you can confirm.

Any spending that isn't assigned to a specific category allocation is treated as **Uncategorized** and appears in the budget donut chart and the budget detail page. You can add category allocations at any time after saving.
