...
You can finish the budget setup wizard and save a budget that only has an overall monthly amount, without splitting it across any categories. The **Save** button is enabled as long as the budget is initialized and you have not over-allocated. Any unallocated amount is treated as **Uncategorized** spending and is visible in the budget donut chart and the budget detail page.
