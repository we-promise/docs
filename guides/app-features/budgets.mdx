...
You can finish creating a budget without allocating any spending to specific categories. The **Save** button in the budget setup wizard only requires a valid start date — you do not need to assign any category amounts before saving.

An unallocated budget treats all spending as "Uncategorized" in the donut chart and budget show page. You can add category allocations at any time after saving.
