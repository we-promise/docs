...
You can save a budget that only sets an overall monthly spending amount without splitting it across categories. The budget setup wizard no longer requires any category allocation before you can confirm. Any unallocated amount is treated as "Uncategorized" spending, visible in the donut chart and budget detail page.
