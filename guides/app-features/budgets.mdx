...
When creating a budget, you can set an overall monthly spending amount without allocating it to any specific categories. This is useful when you want to track total spending before deciding how to split it. You can always add category allocations later.

The budget setup wizard lets you save as soon as you have a valid budget — you do not need to allocate any amount to categories first. Any unallocated amount is treated as "Uncategorized" spending in the donut chart and budget detail view.
