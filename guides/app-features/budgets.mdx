...
You can save a budget that only sets an overall monthly amount without splitting it across categories. The **Save** button is enabled as long as a budget exists and you have not over-allocated — you do not need to allocate any amount to categories first.

Any unallocated amount is treated as "Uncategorized" and appears in the budget donut chart and the budget detail page. You can add category allocations later at any time.
