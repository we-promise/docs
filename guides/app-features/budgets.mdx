...
You can save a budget with only an overall monthly amount set, without splitting it across categories. The **Save** button is enabled as long as a budget has been initialized and you have not over-allocated — a zero category allocation is valid.

Any unallocated amount is treated as **Uncategorized** and appears in the donut chart and budget show page accordingly. You can always add category allocations later by editing the budget.
