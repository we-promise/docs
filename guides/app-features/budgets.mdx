...
You can save a budget with only an overall monthly amount set, without splitting it across categories. The full amount appears as "Uncategorized" in the budget donut chart and show page until you add category allocations later.

The budget setup wizard's **Save** button is available as long as a budget has been initialized and the total allocated amount does not exceed the overall budget — you do not need to allocate anything to categories before saving.
