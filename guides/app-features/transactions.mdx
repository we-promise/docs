...
The category filter includes an **Uncategorized** option that matches transactions with no category assigned. The merchant filter includes a **No merchant** option that matches transactions with no merchant assigned. The tag filter includes an **Untagged** option that matches transactions with no tags applied. Each of these options can be combined with real category, merchant, or tag selections in the same filter.
