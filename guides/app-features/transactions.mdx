...
If the category you need doesn't exist yet, you can create it inline from the category selector without leaving the transaction form. Type the new category name and choose the option to create it.
