...
You can also create a new category directly from the transaction form without leaving the transaction. Type a new category name in the category field and select **Create category** to add it on the spot.
