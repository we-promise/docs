...
When viewing transactions filtered by transfer type, Sure displays **Inflow** and **Outflow** totals instead of the standard Income and Expenses labels:

- **Inflow** - Total money flowing into accounts from transfers
- **Outflow** - Total money flowing out of accounts from transfers

This provides a clearer picture of money movement when you're specifically looking at transfers.

> [!NOTE]
> When viewing mixed filters (transfers combined with other transaction types), the summary bar shows Income/Expenses and excludes transfer amounts to avoid confusion.
