...
**CSV exports.** When you click an export link in the desktop app, the file is saved to your Downloads folder using a native download. A macOS notification appears when the download finishes or if it fails.
