...
When you buy or sell securities, you can record trades manually in Sure. Each trade includes:

- **Type**: Buy or Sell
- **Security**: The stock, ETF, or crypto you're trading
- **Quantity**: Number of shares or units
- **Price**: Price per share at the time of trade
- **Fee**: Optional transaction fee charged by your broker
- **Date**: When the trade occurred

### Transaction Fees

Trades support an optional **fee** field to track brokerage commissions and transaction costs. The fee is included in the total amount calculation:
