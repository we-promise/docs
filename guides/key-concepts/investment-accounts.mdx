...
Dividends and interest are recorded as **trades** with zero quantity and zero price, maintaining the security association:

- **Dividends**: Require a security selection (the stock or fund paying the dividend)
- **Interest**: Can be associated with a security or fall back to a synthetic cash security for the account

This approach ensures all investment income is properly tracked and associated with the correct securities in your portfolio.
