...
Sure supports recording various types of trades in your investment accounts:

### Buy and Sell Trades

Record purchases and sales of securities:

1. Navigate to your investment account
2. Click **Add Trade**
3. Select **Buy** or **Sell** as the trade type
4. Choose the security from the dropdown
5. Enter:
   - **Quantity**: Number of shares or units
   - **Price**: Price per share
   - **Fee** (optional): Transaction fees or commissions
6. The total amount is calculated automatically: `(quantity × price) + fee`

### Dividends and Interest

Investment income is recorded as trades with zero quantity and price:

**Recording Dividends:**

1. Click **Add Trade**
2. Select **Dividend** as the trade type
3. Choose the security that paid the dividend
4. Enter the dividend amount received
5. The trade is created with `qty: 0` and `price: 0`

**Recording Interest:**

1. Click **Add Trade**
2. Select **Interest** as the trade type
3. Optionally select a security (if interest is tied to a specific holding)
4. If no security is selected, Sure creates a synthetic cash security for the account
5. Enter the interest amount received
...
- **Brokerage commissions**: Fees charged by your broker
- **Exchange fees**: Fees charged by the exchange
- **Other transaction costs**: Any additional costs associated with the trade

Fees are included in the total amount calculation and affect your cost basis tracking.
