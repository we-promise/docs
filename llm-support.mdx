...
| `LLM_MAX_RESPONSE_TOKENS` | Tokens reserved for the model's reply; sent to the provider as `max_tokens` (Chat Completions) or `max_output_tokens` (Responses API) when set | `512` |
