...
The AI Provider form contains the following fields:

**Provider & credentials**
- **LLM Provider** — `openai` or `anthropic`
- **Access Token** — API key for the selected provider
- **URI Base / Base URL** — Custom endpoint URL (optional; required for Ollama, LM Studio, Bedrock, Vertex, etc.)
- **Model** — Model name (required for custom endpoints)

**Behavior**
- **JSON Mode** — Output mode: `auto`, `strict`, `json_object`, or `none`
