...
## Reports and spending breakdowns

The reports section gives you a breakdown of your income and expenses by category. You can drill down from any category row directly into the filtered transaction list to see the individual transactions behind the numbers.

### Drilling down into categories

Click any income or expense category row in the reports breakdown to open your transaction list filtered to that category. This matches the same drill-down behavior available on the dashboard.

<Note>
Rows labeled **Other Investments** are not clickable because they represent trade-only activity that cannot be shown in the standard transaction list.
</Note>
