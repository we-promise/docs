...
- `chat_golden_v2` - routing and analytical tool scenarios; exercises CHAT classification (no tools), aggregate queries routed to `get_income_statement` / `get_balance_sheet`, and new analytical tool selection
