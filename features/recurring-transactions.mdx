...
If a manual recurring transaction already exists for the same pattern, the **Mark as Recurring** button is disabled and shows the reason inline. You do not need to attempt the action to find out — the view reflects the current state before you click.
